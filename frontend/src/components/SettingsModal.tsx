        ...
        <div className="grid gap-4">
          ...
          <Card className="p-4">
            ...
            <div className="space-y-3">
              <Input 
                placeholder="Enter Pixel ID (e.g., 123456789012345)"
          ...
          <Card className="p-4">
            ...
            <div className="space-y-3">
              <Input 
                placeholder="Enter Conversion ID (e.g., AW-123456789)"
                className="bg-input-background"
              />
              <Input 
                ...
                {settingsMenuItems.map((item) => {
                  ...
                  return (
                    <Button
                      key={item.id}
                      variant="ghost"
                      className={`w-full justify-start gap-3 h-10 text-left px-3 rounded-lg transition-colors ${
