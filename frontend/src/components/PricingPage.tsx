...
export function PricingPage({ onClose, onPlanSelected }: PricingPageProps) {
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {plans.map((plan) => (
            <Card 
              key={plan.id}
              className={`relative p-8 transition-all duration-300 border-2 min-h-[500px] flex flex-col ${
