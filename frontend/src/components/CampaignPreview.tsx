              ...
              <Card className="p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {campaign.googleAds.keywords.map((keyword: string, index: number) => (
              ...
              <Card className="p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {campaign.facebookAds.audiences.map((audience: string, index: number) => (
                        <div key={index} className="flex items-center gap-2">
